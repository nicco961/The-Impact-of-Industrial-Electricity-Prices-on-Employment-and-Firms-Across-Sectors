...
esttab ev1 ev3 using "C:\Users\nicco\OneDrive\Desktop\Industry occupation electricity prices\results\tables\IV results excl small elec markets\iv_all_sectors.tex", replace tex keep(rate_electricity) p star(* 0.1 ** 0.05 *** 0.01) 
